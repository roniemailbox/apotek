...
class Mskategori extends CI_Controller{
  ...
  function index()
  {
    ...
    $query_data="SELECT
      ...
      $data=array(
          ...
          'title_filter'=>'Cari Kategori',
          'title_tambah'=>'Input Kategori Baru',
  ...
  {
    $id = get_cookie('eklinik');
    $id_edit=$this->input->post('id_kategori');
    $query_data="SELECT
                  ms_kategori.id_kategori,
                  ms_kategori.nama,
                  ms_kategori.keterangan,
      ...
      $query_data_edit="SELECT
                  ...
                  WHERE
                  ms_kategori.id_kategori = '$id_edit'";
      ...
      $data=array(
          ...
          'title'=>'Master kategori',
          'title_filter'=>'Cari Kategori',
          'title_tambah'=>'Edit Data Kategori',
          
          'data_kategori_edit'=>$this->Bis_model->manualQuery($query_data_edit),
          'data_status_aktif' => $this->Bis_model->getAllData('ms_status_aktif'),
          'data_kategori'=>$this->Bis_model->manualQuery($query_data),
          'users'=>$this->Hak_Akses_m->get_user($id),
          'menu'=>$this->Menu_m->get_menu($id),
...
//    ===================== INSERT =====================
    function tambah()
    {
      ...
      /*$id_kategori= $this->Bis_model->getIdkategori();*/
      $data=array(
      ...
      function filter(){
        ...
        $query_data="SELECT
                    ...
                    LEFT JOIN ms_pegawai ON `user`.id_pegawai = ms_pegawai.id_pegawai
                    LEFT JOIN ms_status_aktif ON ms_kategori.status_aktif = ms_status_aktif.id_status_aktif
                    WHERE ms_kategori.nama like '%$filter%' or ms_kategori.id_kategori like '%$filter%'
                    ORDER BY ms_kategori.nama ASC ";
        //echo $query_data;
        $data=array(
          'perintah' => 'Baru',
          'title'=>'Master kategori',
