       ...
       <td><div class="container">
         ...
         <table width="100%" border="0" cellspacing="1" cellpadding="1">
           ...
           <tbody>
             ...
             <tr>
               ...
               <td width="1%">:</td>
               <td width="44%"><?php echo $row->nama_dokter; ?></td>
               <td width="10%">&nbsp;</td>
               <td width="1%">&nbsp;</td>
               <td width="33%">&nbsp;</td>
             </tr>
         ...
         <table border="0"  width="100%"
           ...
           <tr style="font-weight:bold">
             <td colspan="4" align="center" style="background:#FFFFFF"><hr style="height:0px;border:0.5px solid black;"/></td>
           </tr>
           <tr style="font-weight:bold">
             <td colspan="4" align="left" style="background:#FFFFFF"><h3>&nbsp;</h3></td>
           </tr>
           </table>
         <?php }
 												}
...
<script>
                function printDiv(divName) {
                  ...
                  w.document.write('<title><?= $this->session->userdata('nama_perusahaan'.$id)?></title>');
							...
							w.document.write('<style>@page { size: A5 portrait }</style>');
