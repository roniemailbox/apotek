...
LEFT JOIN ms_status_aktif ON ms_jabatan.status_aktif = ms_status_aktif.id_status_aktif ORDER BY ms_jabatan.nama ASC";
...
//    ===================== INSERT =====================
    function tambah()
    {
      ...
      function baru(){
        ...
        $this->load->view('Msjabatan_baru_view',$data);
      }
      ...
      function filter(){
        ...
        $query_data="SELECT
                    ...
                    WHERE ms_jabatan.nama like '%$filter%' ORDER BY ms_jabatan.nama ASC ";
        //echo $query_data;
        $data=array(
            'title'=>'Master jabatan',
            'xmenu'=>'Master',
	  ...
	  function ambiledit($ids)
        ...
        $query_supplier="select * from ms_supplier";
        $query_jenis="select * from ms_jenis_jabatan";
        $query_kategori="select * from ms_kategori";
        $query_satuan="select * from ms_satuan";
        $query_data="SELECT
                    ms_jabatan.id_jabatan,
                    ...
                    LEFT JOIN ms_pegawai ON `user`.id_pegawai = ms_pegawai.id_pegawai
                    LEFT JOIN ms_status_aktif ON ms_jabatan.status_aktif = ms_status_aktif.id_status_aktif
                    WHERE ms_jabatan.id_jabatan = '$id_jabatan'";
        //echo $query_data;
        $data=array(
            'perintah'=>'Update',
            'title'=>'Master jabatan',
            'xmenu'=>'Master',
            'xsubmenu'=>'Master jabatan',
