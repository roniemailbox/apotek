...
class Msbarang extends CI_Controller{
  ...
  function index()
  {
    ...
    $query_satuan2="select * from ms_satuan";
    ...
    $query_data="SELECT
                ...
                ms_s1.nama AS nama_satuan,
                ms_s2.nama AS nama_satuan2,
		ms_s1.id_satuan AS id_satuan,
                ms_s2.id_satuan AS id_satuan2,
                ...
                LEFT JOIN ms_satuan AS ms_s1 ON ms_barang.satuan = ms_s1.id_satuan
                LEFT JOIN ms_satuan AS ms_s2 ON ms_barang.satuan_besar = ms_s2.id_satuan
                LEFT JOIN ms_tipe ON ms_barang.id_tipe = ms_tipe.id_tipe
                LEFT JOIN judul_racikan ON ms_barang.no_bukti = judul_racikan.no_bukti LIMIT 100";
                $query_count_detail="SELECT
                                ...
                                LEFT JOIN ms_satuan AS ms_s2 ON ms_barang.satuan_besar = ms_s2.id_satuan
                                LEFT JOIN ms_tipe ON ms_barang.id_tipe = ms_tipe.id_tipe
                                LEFT JOIN judul_racikan ON ms_barang.no_bukti = judul_racikan.no_bukti";
      ...
      $data=array(
          ...
          'data_satuan2'=>$this->Bis_model->manualQuery($query_satuan2),
    ...
    $query_data="SELECT
		...
		ms_s1.id_satuan AS id_satuan,
                ...
                LEFT JOIN judul_racikan ON ms_barang.no_bukti = judul_racikan.no_bukti
                  ...
                  OR ms_barang.no_bukti like '%$filter%'
...
//    ===================== INSERT =====================
    function tambah()
    {
      ...
      $id_barang= $this->Bis_model->getIdBarang($kode_bukti);
      //$id_barang='ITM'.time();
      $kode_barang="RCK".$pad_kd_sub_unit.$year.$month;
      $no_bukti=$this->Bis_model->getIdBarang($kode_barang);
      $data=array(
          'id_barang'=>$id_barang,
          'no_bukti'=>$no_bukti,
