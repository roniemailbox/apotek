...
class Sitranst extends CI_Controller
{
  public $CI = NULL;
  ...
  function index()
  {
    ...
    $query_data="SELECT
            ...
            $data=array(
                'title'=>'Data Penjualan Kredit / Tunai',
                'xmenu'=>'Barang Keluar',
                'xsubmenu'=>'Penjualan',
            ...
            $this->load->view('Sitranst_view',$data);
          }
  ...
  function baru(){
    ...
    $this->load->view('Sitranst_baru_new',$data);
  }
