     ...
     <div class="row">
         ...
         <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="input-group">
                ...
                <input type="text" id="no_register" value="<?php // $this->session->userdata('id_user'.$id)?>" name="no_register" class="form-control" placeholder="No Register" readonly>
              </div>
              ...
              <div class="input-group">
                ...
                <input type="text" id="telepon" value="<?php //$this->session->userdata('jk'.$id)?>" name="jk" class="form-control" placeholder="Keterangan" readonly>
       ...
       <div class="col-md-6">
           ...
           <div class="box box-info">
             <div class="box-header">
               <h3 class="box-title">Informasi Kunjungan
                 <small></small>
               </h3>
               ...
               <div class="input-group">
                 ...
                 <input type="number" value="" name="tekanan_darah" class="form-control" placeholder="Tekanan Darah" >
               </div>
             ...
             <div class="box-body pad">
               <h5>Keluhan</h5>
                     <textarea id="editor1" name="editor1" rows="5" cols="80" placeholder="Keperluan Surat">
       ...
       <div class="col-md-12">
           ...
           <div class="box box-info">
             ...
             <div class="box-header">
               <h3 class="box-title">Daftar Kunjungan Pasien
                 <small></small>
               </h3>
