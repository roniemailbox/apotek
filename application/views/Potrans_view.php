       ...
       <div class="col-xs-12">
         ...
         <div class="box">
          ...
          <div class="box-header">
            ...
            if($hak_c == 1)
            { ?>
               <a href="<?php echo site_url('Potrans/baru'); ?>" class="btn btn-block btn-primary btn-flat"><i class="fa fa-plus-square-o"></i> Input Baru</a>
           ...
           <div class="modal fade" id="modal-default">
             <div class="modal-dialog">
               <div class="modal-content">
                 <form class="form-horizontal" method="post" action="<?php echo site_url('Potrans/filter')?>">
           ...
           <tr>
             <td>
               ...
               if($hak_u == 1)
               {
                 ...
                 {
                    ?>
                    <a href="<?php echo site_url('Potrans/ambil_edit/'.$row->no_bukti);?>" class="btn btn-info btn-xs"
                    ...
                    <?php
                     ...
                     ?>
                     <a href="<?php echo site_url('Potrans/ambil_edit/'.$row->no_bukti);?>" class="btn btn-info btn-xs"
                     onclick="return confirm('Anda yakin edit data <?php echo $row->no_bukti; ?> ini....????')" disabled="disabled"> <i class="fa fa-pencil"></i> Edit</a>
                     <?php
                   }
               ...
               if($hak_d == 1)
               {
                 ...
                 {
                    ?>
                    <a href="<?php echo site_url('Potrans/hapus/'.$row->no_bukti);?>" class="btn btn-danger btn-xs"
                  ...
                  ?>
                  <a href="<?php echo site_url('Potrans/hapus/'.$row->no_bukti);?>" class="btn btn-danger btn-xs"
                  onclick="return confirm('Anda yakin menghapus data <?php echo $row->no_bukti; ?> ini....????')" disabled="disabled"> <i class="fa fa-trash"></i> Hapus</a>
                  <?php
                }
               ...
               {
                 ?>
                 <a href="<?php echo site_url('Potrans/cetak/'.$row->no_bukti);?>" class="btn btn-success btn-xs" target="_blank"> <i class="fa fa-print"></i> Cetak</a>
               <?php
               }
