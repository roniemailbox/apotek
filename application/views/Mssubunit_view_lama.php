         ...
         <div class="box">
          ...
          <?php //include 'template/Pesan.php'; ?>
           <div class="box-header">
               ...
               <a href="<?php echo site_url('mssubunit/baru'); ?>" class="btn btn-block btn-primary btn-flat"><i class="fa fa-plus"></i> Input Baru</a>
           ...
           <div class="box-body">
             <table id="example2" class="table table-bordered table-striped nowrap"  cellspacing="0" width="100%">
               ...
               <tbody>
                <!--
               <a class="btn btn-mini" href="<?php //echo site_url('master/hapus_subunit/'.$row->kd_subunit);?>"
           ...
           <tr>
             <td>
               ...
               if($hak_u == 1)
               {
                 ...
                 <a href="<?php echo site_url('Mssubunit/ambiledit/'.$row->kd_sub_unit);?>" class="btn btn-info btn-xs"
               ...
               {
                 ?>
                 <a href="<?php echo site_url('Mssubunit/hapus/'.$row->kd_sub_unit);?>" class="btn btn-danger btn-xs"
