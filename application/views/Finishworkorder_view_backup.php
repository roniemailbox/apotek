                                          ...
                                          <div class="box-comment">
                                            ...
                                            <div class="comment-text">
                                                  <span class="username">
                                                    ...
                                                    <span class="text-muted pull-right"><?php echo $rowhis->no_wo ." : ". $rowhis->tgl_masuk ?></span>
                                                  </span><!-- /.username -->
                                                  <span class="username"><a href="#"><?php echo "Subjective :" ?></a></span>
                                                  <?php echo $rowhis->subjective ?>
                                                  <span class="username"><a href="#"><?php echo "Objective :" ?></a></span>
                                                  <?php echo $rowhis->objective ?>
                                                  <span class="username"><a href="#"><?php echo "Assesment :" ?></a></span>
                                                  <?php echo $rowhis->assesment ?>
                                                  <span class="username"><a href="#"><?php echo "Planing :" ?></a></span>
                               ...
                               <div class="box-footer box-comments">
                                 ...
                                 <div class="box-comment">
                                   ...
                                   <div class="comment-text">
                                         <span class="username">
                                           <?php echo "Dokter : ". $rowhis->nama_dokter ?>
                                           <span class="text-muted pull-right"><?php echo $rowhis->tgl_masuk ?></span>
                                         </span><!-- /.username -->
                                         <span class="username"><a href="#"><?php echo "Tindakan :" ?></a></span>
                                     <?php echo $rowhis->tindakan ?>
                                   </div>
                                   <!-- /.comment-text -->
                                 </div>
                                 <!-- /.box-comment -->
