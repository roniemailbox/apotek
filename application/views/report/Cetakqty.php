				...
				<table border="0"  width="100%"
			  										...
			  										<tr>
			  										  <td style="text-align:center; font-weight:bold;"
			  												colspan='10' align='center'>MASTER BARANG</td>
			  										  </tr>
			  										<tr>
			  											<td colspan='10' align='center'><hr style="height:0px;border:0.5px solid black;"/></td>
			  										</tr>
			  										<tr>
			  											<th width="6%" style="width:3%; text-align:center;">No</th>
			  											<th width="20%" style="width:10%; text-align:center;">Kode</th>
															<th width="20%" style="width:10%; text-align:center;">Kode Lama</th>
			  										  <th width="18%" style="width:10%; text-align:center;">Barcode</th>
			  											<th width="27%" style="width:47%; text-align:center;">Item</th>
															...
															<th width="27%" style="width:10%; text-align:center;">Harga Beli</th>
...

			                                   {
			                                        ...
			                                        <tr class="records">
			                                          ...
			                                          <td valign="top"> <?php echo $row->id_barang; ?></td>
																								<td align="left" valign="top"><?php echo $row->nama_alias; ?> </td>
			  																				<td align="left" valign="top"><?php echo $row->barcode; ?> </td>
			  																				<td style="padding-bottom: 10px" valign="top"> <?php echo $row->nama; ?></td>
																								<td align="leftr" valign="top"> <?php echo $row->satuan; ?></td>
																								<td align="right" valign="top"> <?php echo number_format($row->hb); ?></td>
																								<td align="right" valign="top"> <?php echo number_format($row->hj); ?></td>
