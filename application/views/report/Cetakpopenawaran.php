			  ...
			  <table width="100%" border="0" cellspacing="1" cellpadding="1">
 	            ...
 	            ?>
				    ...
				    <tbody>
						    ...
						    <tr>
						      <td colspan="7" align="center"><h4>SURAT PERMINTAAN PENAWARAN HARGA</h4></td>
						    </tr>
						    <tr>
						      <td>&nbsp;</td>
						      <td>No Bukti</td>
...
<table border="0"  width="100%"
										...
										<tr>
										  <td style="text-align:center; font-weight:bold;"
												colspan='6' align='center'>DETAIL PART ITEM</td>
										  </tr>
										<tr>
...
<th width="19%" style="width:17%; text-align:center;">Kd Barang</th>
											<th width="19%" style="width:17%; text-align:center;">Part Numbar</th>
											<th width="30%" style="width:35%; text-align:center;">Part Name</th>
											<th width="13%" style="width:5%; text-align:center;">Harga</th>
