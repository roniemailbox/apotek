...
<hr style="height:0px;border:0.5px solid black;"/>
	    <div align="center">
	        ...
	        <h3>REKAP DATA OB REMOVAL <?php echo $row->nama; ?></h3>
				<?php
					}
				}
				?>
	        ...
	        <table border="0" width="100%" cellspacing="0" cellpadding="0"
	            ...
	            <tr>
	              <th colspan="13"><hr style="height:0px;border:0.5px solid black;"/></th>
              </tr>
	            <tr>
	                <th>NO</th>
									<th>NO BUKTI</th>
	             ...
	             <tr>
	              <td colspan="13"><hr style="height:0px;border:0.5px solid black;"/></td>
                </tr>
	            ...
	            foreach($data_hauling as $row){
					$xtotal=$xtotal+$row->tsss;
					$xdiskon=$xdiskon+$row->ob;
					$xdpp=$xdpp+$row->mud;
					$xcoal=$xcoal+$row->coal;
	            ?>
	            ...
	            <tr>
                                    ...
                                    <td align="center"><?php echo format_tanggal($row->tgl_produksi); ?></td>
                         						 <td align="center"><?php echo $row->nama_customer;?></td>
																		...
																		<td align="right"><?php echo number_format($row->tsss,2);?></td>
																		<td align="right"><?php echo number_format($row->ob,2);?></td>
																		<td align="right"><?php echo number_format($row->mud,2);?></td>
																			<td align="right"><?php echo number_format($row->coal,2);?></td>
...
<td>&nbsp;</td><td>&nbsp;</td>
	              ...
	              <td align="right"><h3><?php echo number_format($xtotal,2);?></h3></td>
									<td align="right"><h3><?php echo number_format($xdiskon,2);?></h3></td>
									<td align="right"><h3><?php echo number_format($xdpp,2);?></h3></td>
									<td align="right"><h3><?php echo number_format($xcoal,2);?></h3></td>
	              <td align="left">&nbsp;</td>
