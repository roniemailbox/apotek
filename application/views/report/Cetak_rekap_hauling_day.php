...
<th>SHIFT</th>
	            ...
	            <tr>
                                    ...
                                    <td align="center"><?php echo format_tanggal($row->tgl_produksi); ?></td>
																		...
																		<td align="center"><?php echo $row->nama_shift ?></td>
																		...
																		<td align="center"><?php echo $row->rit;?></td>
...
<td align="right"><?php echo number_format($xdpp);?></td><td align="center"><?php echo number_format($xrit);?></td>
