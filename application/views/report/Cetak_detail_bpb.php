...
<hr style="height:0px;border:0.5px solid black;"/>
	    <div align="center">
	        <h3 style="border: 0px solid #333;">REKAP DETAIL PEMBELIAN<br>
	        ...
	        <table border="0" width="100%" cellspacing="0" cellpadding="0"
              ...
              $tgl_trans = $dt['tgl_trans'];
                ...
                <tr valign="middle" class="td_only" style="font-weight:bold; color:rgb(0,0,0); background:#D3D1D1">
															<td colspan="8" valign="middle" align="left" style="width:100%; font-weight:bold; height:25px">
														...
														foreach ($dt['dt_unit_x_l0'] as $dt_l0){
															...
															foreach ($get_query_l3 as $dt_l3){
																...
																<tr class="td_only">
																	...
																	<td>&nbsp;&nbsp;<?php	echo  $dt_l3['part_number'];?></td>
																	<td>&nbsp;&nbsp;<?php echo  $dt_l3['nama_barang']; ?> </td>
																	<td align="right"><?php echo  number_format($dt_l3['hb']); ?> &nbsp;&nbsp;</td>
																	<td align="right"><?php echo  number_format($dt_l3['ppn']); ?> &nbsp;&nbsp;</td>
														    ...
														    <tr class="td_only">
															      <td colspan="8" align="left" style="font-weight:bold"> </td>
		        </tr>
														    <tr class="td_only">
																<td colspan="4" align="left" style="font-weight:bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
																<td align="right" bgcolor="#CCCCCC" style="font-weight:bold; height:25px"><?php  echo  number_format($total_d); ?>&nbsp;&nbsp;</td>
                                                                <td align="right" bgcolor="#CCCCCC" style="font-weight:bold"><?php  echo  number_format($total_p); ?>&nbsp;&nbsp;</td>
                                                                <td align="center" bgcolor="#CCCCCC" style="font-weight:bold"><?php  echo  number_format($total_q); ?>&nbsp;&nbsp;</td>
                                                                <td align="right" bgcolor="#CCCCCC" style="font-weight:bold"><?php echo  number_format($total_t); ?>&nbsp;&nbsp;</td>
														...
														?>
                <tr class="td_only">
                                                              <td colspan="8" align="right" style="font-weight:bold">&nbsp;</td>
                </tr>
                <tr class="td_only">
																<td colspan="7" align="right" style="font-weight:bold; height:25px">Total Per Hari&nbsp;&nbsp;</td>
                ...
                <tr>
	              <td colspan="7" align="right" style="font-weight:bold"><strong>Grand Total&nbsp;&nbsp;</strong></td>
