...
<hr style="height:0px;border:0.5px solid black;"/>
	    <div align="center">
	        ...
	        s/d <?php echo format_tanggal($xtglakhir); ?>
	            ...
	            <tr>
	              ...
	              <th width="33%" rowspan="2">TANGGAL</th>
				...
				$xppn=0;
				$xsubtotal=0;
				if(isset($data_rekap1)){
	            foreach($data_rekap1 as $row){
					$xrit=$xrit+$row->rit;
	            ...
	            <tr>
                                    ...
                                    <td align="center"><?php echo number_format($row->rit) ?></td>
                ...
                <tr>
	              <td colspan="4" align="right" valign="middle" style=" font-weight:bold"> Total </td>
	              <td align="center" valign="middle" style=" font-weight:bold"> <?php echo number_format($xrit);?> </td>
