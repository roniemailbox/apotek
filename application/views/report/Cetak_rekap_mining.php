...
<hr style="height:0px;border:0.5px solid black;"/>
	    <div align="center">
	        ...
	        <h3>REKAP DATA ALAT BERAT <?php echo $row->nama; ?></h3>
				<?php
					}
				}
				?>
...
<td align="center"><?php echo $row->nama_plant ?></td>
																		...
																		<td align="right"><?php echo number_format($row->pwh);?></td>
																		<td align="right"><?php echo number_format($row->hmawal,2);?></td>
																		<td align="right"><?php echo number_format($row->hmakhir,2);?></td>
																		<td align="right"><?php echo number_format($row->hmtotal,2);?></td>
