       ...
       <td><div class="container">
         ...
         <table width="100%" border="0" cellspacing="1" cellpadding="1">
           ...
           <tbody>
             ...
             <tr>
               <td colspan="7" align="center"><h3>BUKTI PEMAKAIAN</h3></td>
             </tr>
             <tr>
             ...
             <tr>
               ...
               <td>:</td>
               <td rowspan="2" valign="top" style="font-weight:bold"><?php echo $row->id_beban.' - '.$row->nama ?></td>
               <td>No. Faktur</td>
               <td>:</td>
             ...
             <tr>
               ...
               <td width="11%">Unit</td>
               <td width="1%">:</td>
               <td width="44%"><?php echo $row->id_unit; ?></td>
               <td width="10%">&nbsp;</td>
               <td width="1%">&nbsp;</td>
               <td width="33%">&nbsp;</td>
             </tr>
         ...
         <table border="0"  width="100%"
           ...
           <tr>
             <td colspan="2" rowspan="4" align="center" style="background:#FFFFFF"><table width="98%" border="0">
               <tr>
                 <td width="32%" align="center">Pemohon</td>
                 <td width="31%" align="center">Penerima</td>
                 <td width="37%" align="center">Pembuat</td>
               </tr>
               <tr>
