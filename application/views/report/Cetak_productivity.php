...
<hr style="height:0px;border:0.5px solid black;"/>
	    <div align="center">
	        ...
	        <table border="0" width="100%" cellspacing="0" cellpadding="0"
	            ...
	            <tr>
	              <th colspan="14"><hr style="height:0px;border:0.5px solid black;"/></th>
              </tr>
	            <tr>
	                <th>NO</th>
									<th>NIK</th>
...
<th>PLANT</th>
	             ...
	             <tr>
	              <td colspan="14"><hr style="height:0px;border:0.5px solid black;"/></td>
                </tr>
...
<td>&nbsp;</td><td>&nbsp;</td>
	              ...
	              <td align="right"><h3>&nbsp;</h3></td>
									<td align="right"><h3><?php echo number_format($xtotal);?></h3></td>
									<td align="right"><h3><?php echo number_format($xdiskon);?></h3></td>
								<td align="right"><h3><?php echo number_format($xdpp);?></h3></td>
	              <td align="left">&nbsp;</td>
