	    ...
	    <div align="center">
				...
				<table border="0"  width="100%"
			  										...
			  										<tr>
			  											...
			  											<th width="6%" style="width:10%; text-align:center;">Tanggal</th>
			  											<th width="20%" style="width:10%; text-align:center;">No Bukti</th>
															<th width="20%" style="width:37%; text-align:center;">Nama</th>
			  										  <th width="18%" style="width:10%; text-align:center;">Qty</th>
			  											<th width="27%" style="width:10%; text-align:center;">Harga</th>
			  											<th width="18%" style="width:5%; text-align:center;">Satuan</th>
			  											<th width="18%" style="width:5%; text-align:center;">Total</th>
			                      ...
			                      <tbody id="containeritem" style="height: 100px; overflow: auto;">
			                        <?php
			  												$count=0;
																 $qty=0;
			                           if(isset($data_barang_detail))
			                              {
			                                foreach ($data_barang_detail as $row)

			                                   {
			                                        ...
			                                        <tr class="records">
			                                          ...
			                                          <td valign="top"> <?php echo $row->tgl_trans; ?></td>
			  																				<td align="left" valign="top"><?php echo $row->no_bukti; ?> </td>
			  																				<td style="padding-bottom: 10px" valign="top"> <?php echo $row->nama; ?></td>
			  																				<td align="center" valign="top"> <?php echo $row->qty; ?></td>
			                                          <td align="right" valign="top"><?php echo $row->harga; ?> </td>
																								<td align="right" valign="top"><?php echo $row->satuan; ?> </td>
																								<td align="right" valign="top"><?php echo $row->total; ?> </td>
			                                        </tr>
			                                          ...
			                                          <td colspan="8" align="center"><hr style="height:0px;border:0.5px solid black;"/></td>
																	 ...
																	 <td>STOK AKHIR </td>
																	   <td align="right"><strong><?php //echo number_format($qty); ?></strong></td>
																	     <td align="center"><strong><?php echo number_format($qty); ?></strong> </td>
																			 <td> </td>
																	 <td align="right"> </td>
