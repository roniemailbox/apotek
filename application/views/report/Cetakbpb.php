			  ...
			  <table width="100%" border="0" cellspacing="1" cellpadding="1">
 	            ...
 	            ?>
				    ...
				    <tbody>
						    ...
						    <tr>
						      <td colspan="7" align="center"><h4>BUKTI PENERIMAAN BARANG (BPB)</h4></td>
						    </tr>
						    <tr>
						      <td>&nbsp;</td>
						      <td>No Bukti</td>
						    ...
						    <tr>
						      ...
						      <td width="33%" valign="top"><?php echo $row->alamat; ?></td>
						    </tr>
						    <tr>
						      <td>&nbsp;</td>
						      <td>Keterangan</td>
...
<table border="0"  width="100%"
										...
										<tr>
										  <td style="text-align:center; font-weight:bold;"
												colspan='8' align='center'>DETAIL PART ITEM</td>
										  </tr>
										<tr>
...
<th style="width:17%; text-align:center;">Kd Barang</th>
											<th style="width:17%; text-align:center;">Part Numbar</th>
											<th style="width:35%; text-align:center;">Part Name</th>
											<th style="width:5%; text-align:center;">Dpp</th>
											<th style="width:5%; text-align:center;">Ppn</th>
                    ...
                    <tbody id="containeritem" style="height: 100px; overflow: auto;">
                      <?php
                        $count = 0;
                         ...
                         if(isset($detail_bpb))
                            {
                              foreach ($detail_bpb as $row)

                                 {
								 $count++;
								 $totalqty=$totalqty+$row->qty;
								 $totalbeli=$totalbeli+($row->qty*($row->hb+$row->ppn));
								  ?>
                                      ...
                                      <tr class="records">
                                        ...
                                        <td><?php echo $row->nama_barang; ?></td>
																				<td><?php echo number_format($row->hb); ?></td>
...
<tr>
										...
										<tr style="background-color:#B0B0AD; color:white; font-weight:bold">
											<td colspan="5" align="center" style="height:25px">Total &nbsp;</td>
                                            <td >&nbsp; </td>
											<td align="center"><?php echo $totalqty; ?></td>
											<td align="right"><?php echo number_format($totalbeli); ?></td>
										</tr>
	  </table>
	    </div>
            ...
            <td width="26%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody>
                <tr>
                  <td width="32%">Dpp</td>
                  <td width="4%">:</td>
                  <td width="64%" align="right"><?php echo  number_format($row->dpp) ; ?></td>
                </tr>
                <tr>
                  <td>PPN</td>
                  <td>:</td>
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
                           <tbody>
                             <tr>
                               ...
                               <td width="27%" align="center">Diterima Oleh:</td>
                               <td width="25%">&nbsp;</td>
