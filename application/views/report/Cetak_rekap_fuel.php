...
<hr style="height:0px;border:0.5px solid black;"/>
	    <div align="center">
	        ...
	        <h3>REKAP PEMAKAIAN SOLAR <?php echo $row->nama; ?></h3>
				<?php
					}
				}
				?>
	        ...
	        <table border="0" width="100%" cellspacing="0" cellpadding="0"
	            ...
	            <tr>
	              <th colspan="18"><hr style="height:0px;border:0.5px solid black;"/></th>
              </tr>
	            <tr>
								<th>No</th>
								<th>No Bukti</th>
	             ...
	             <tr>
	              <td colspan="18"><hr style="height:0px;border:0.5px solid black;"/></td>
                </tr>
				...
				$xsubtotal=0;
				if(isset($data_fuel)){
	       foreach($data_fuel as $row){
							$xtotal=$xtotal+$row->jumlah;
	            ...
	            <tr>
								...
								<td><?php echo $row->nama_station; ?></td>

								<td align="left"><?php echo $row->nama_sloc; ?></td>
								<td align="center"><?php echo ambil_bulan($row->tgl_isi); ?></td>

								<td align="center"><?php echo format_tanggal($row->tgl_isi); ?></td>
								<td align="center"><?php echo $row->nama_shif; ?></td>
								<td align="center"><?php echo $row->kmhm; ?></td>
								<td align="center"><?php echo $row->id_unit; ?></td>
								 <td align="center"><?php echo $row->id_model_unit; ?></td>
								 <td align="center"><?php echo $row->no_pol; ?></td>

								<td align="center"><?php echo number_format($row->meterawal,2); ?></td>
								<td align="center"><?php echo number_format($row->meterakhir,2); ?></td>
								<td align="center"><?php echo number_format($row->jumlah,2); ?></td>
								 <td><?php echo $row->nama_driver; ?></td>
								 <td><?php echo $row->nama_sopir; ?></td>
									<td><?php echo $row->nama_fuelman; ?></td>
               ...
               <td>&nbsp;</td>
	              ...
	              <td align="right"><h3>&nbsp;</h3></td>
								<td>&nbsp;</td>
 								<td>&nbsp;</td>
								<td align="center"><h3><?php echo number_format($xtotal,2);?>
							    <?php //echo number_format($xdpp,2);?></h3></td>
								<td align="left">&nbsp;</td>
	              <td align="left">&nbsp;</td>
								<td align="left">&nbsp;</td>
