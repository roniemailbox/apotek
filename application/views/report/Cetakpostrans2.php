...
<a href="<?=site_url('/')?>Potrans/baru" style="width:100%; display:block; font-size:12px; text-decoration: none; text-align:center; color:#FFF; background-color:#005b8a; border:0px solid #007FFF; padding: 10px 1px; margin: 5px auto 10px auto; font-weight:bold;">Kembali</a>
			  ...
			  <table width="100%" border="0" cellspacing="1" cellpadding="1">
 	            ...
 	            ?>
				    ...
				    <tbody>
						    ...
						    <tr>
						      <td colspan="7" align="center"><h4>NOTA PENJUALAN TUNAI (NPT)</h4></td>
						    </tr>
						    <tr>
						      <td>&nbsp;</td>
						      <td>No Bukti</td>
						      ...
						      <td valign="top">:</td>
						      <td valign="top">&nbsp;<?php echo $row->nama_customer.' / '.$row->id_customer; ?></td>
						    </tr>
						    <tr>
						      <td>&nbsp;</td>
						      <td>Tanggal</td>
