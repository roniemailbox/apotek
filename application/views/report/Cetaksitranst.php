...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url('build/css/bootstrapx.css')?>"/>
    ...
    <tr>
      ...
      <div class="container">
		...
		<tbody>
					...
					<tr>
					  <td width="6%" rowspan="5"><img src="<?php echo base_url(); ?>build/images/logo.png" width="200" height="50" alt=""/></td>
			  ...
			  <table width="100%" border="0" cellspacing="1" cellpadding="1">
 	            ...
 	            ?>
				    ...
				    <tbody>
						    ...
						    <tr>
						      <td colspan="7" align="center"><h4>NOTA PENJUALAN</h4></td>
						    </tr>
						    <tr>
						      <td>&nbsp;</td>
						      <td>No Bukti</td>
						      ...
						      <td>Customer</td>
						      <td>:</td>
						      <td><?php echo $row->nama_customer.' / '.$row->npa; ?></td>
						    </tr>
						    <tr>
						      <td>&nbsp;</td>
						      <td>Tanggal</td>
						    ...
						    <tr>
						      ...
						      <td width="10%">Unit Trans</td>
						      <td width="1%">:</td>
						      <td width="33%"><?php echo $row->nama_unit_transaksi; ?></td>
						    </tr>
						    <tr>
						      <td>&nbsp;</td>
...
<th width="8%" style="width:17%; text-align:center;">Kode</th>
											<th width="18%" style="width:17%; text-align:center;">Barcode</th>
											<th width="37%" style="width:35%; text-align:center;">Barang</th>
											<th width="10%" style="width:5%; text-align:center;">Harga</th>
											<th width="7%" style="width:5%; text-align:center;">Qty</th>
...

                                 {
                                      ...
                                      <tr class="records">
                                        ...
                                        <td><?php echo $row->nama_barang; ?></td>
																				<td align="right"><?php echo number_format($row->hj); ?></td>
  ...
  <tbody>
    <tr>
      ...
      <div style="float:inherit;">
                  <!-- Print -->
                  <button type="button" class="btn btn-danger" onclick="printDiv('printableArea');">
                    Print
                  </button>
