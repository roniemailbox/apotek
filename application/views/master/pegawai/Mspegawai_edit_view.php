 ...
 <?php
 					...
 					<div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-2 col-xs-12" value="<?php echo $row->id_pegawai; ?>" name="id_pegawai" placeholder="" type="text" readonly>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-3 col-xs-12" value="<?php echo $row->tgl_masuk; ?>" name="tglmasuk" required="required" placeholder="Tanggal Diterima Kerja" type="date">
                        </div>
                      </div>
                         ...
                         <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Sloc *</label>
                           <div class="col-md-4 col-xs-12">
                             <select class='form-control' id='sloc' name="id_sloc" required>
                                 <option value="<?php echo $row->id_sloc; ?>"><?php echo $row->nama_sloc; ?></option>
                      ...
                      <div class='item form-group'>
                        ...
                        <div class="col-md-4 col-xs-12">
                          <select id="id_plant" class="form-control" name="id_plant" required>
                            <option value="<?php echo $row->id_plant; ?>"><?php echo $row->nama_plant; ?></option>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Departement *</label>
                          <div class="col-md-4 col-xs-12">
                            ...
                            <option value="<?php echo $row->id_departement; ?>"><?php echo $row->nama_departement; ?></option>
                            </select>
                          </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="form-group">
                                 ...
                                 <div class="col-md-8 col-sm-6 col-xs-12">
                                   <input id="id_kabupaten" placeholder="ID Client" value="<?php echo $row->id_kota_lahir; ?>"  type="text" name="id_kota_lahir" hidden="hidden">
                                   <input class="form-control col-md-8 col-xs-12" value="<?php echo $row->kota_lahir; ?>" id="nama_kabupaten" placeholder="Kota / Kabupaten" readonly type="text" name="nama_kabupaten">
                                 </div>
                               </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-3 col-xs-12" value="<?php echo $row->tgl_lahir; ?>" name="tgllahir" placeholder="Tanggal Lahir" type="date">
                        </div>
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Kota
                          ...
                          <div class="col-md-4 col-xs-12">
                            <select class="form-control" name="id_kota">
                              <option value="<?php echo $row->id_kota; ?>"><?php echo $row->alamat_kota; ?></option>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="ktp" placeholder="KTP" type="text" value="<?php echo $row->ktp; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="telepon" placeholder="Telepon" type="text" value="<?php echo $row->telepon; ?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" value="<?php echo $row->email; ?>" name="email" placeholder="E-mail" type="email" >
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" name="no_rekening" placeholder="No Rekening" type="text" value="<?php echo $row->no_rekening; ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-3 col-xs-12" name="tglkeluar" placeholder="Tanggal Keluar Kerja" type="date" value="<?php echo $row->tgl_keluar; ?>">
                        </div>
                      </div>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="item form-group"><table border="0" width="100%"
                         ...
                         if(isset($data_content))
                                 ...
                                 { $count++; ?>
                                      ...
                                      <tr class="records">
                                        <td align="center">
                                          ...
                                          <input style="width:100%; text-align:left" type="text" value="<?php echo $count; ?>" readonly hidden="" />
                                        </td>
                                        <td>
                                          <input class="form-control col-md-2 col-xs-12" style="width:100%" id="kode_barang_<?php echo ($count) ?>" name="kode_barang_<?php echo ($count) ?>" type="text" value="<?php echo $row->jenis; ?>" readonly />
                                        </td>

                                        <td>
                                          <input class="form-control col-md-2 col-xs-12" style="width:100%" id="nama_barang_<?php echo ($count) ?>" name="nama_barang_<?php echo ($count) ?>" type="text" value="<?php echo $row->nama_content; ?>" readonly />
                                           <input style="width:100%" id="id_var_pay_<?php echo ($count) ?>" name="id_var_pay_<?php echo ($count) ?>" type="text" value="<?php echo $row->id_var_payroll; ?>" readonly hidden="" />
                                        </td>

                                        <td>

                                        <input class="form-control col-md-2 col-xs-12" style="width:100%" id="qty_<?php echo ($count) ?>" name="qty_<?php echo ($count) ?>" type="text" value="<?php echo $row->nama_akun; ?>" readonly />
                                        </td>
                                        <td align="center">
                            ...
                            ?>
										...
										<tr style="background-color:#B0B0AD; color:white; font-weight:bold">
											<td align="center">
												<input type="number" class="key_max" id="key_max" value="<?php echo ($count) ?>"
