   ...
   <section class="content">
     ...
     <script type="text/javascript">
         $(document).ready(function() {
             ...
             $("#searchbarcodea").change(function(){
                 ...
                 $.ajax({
                     type: "POST",
                     url: "<?php echo base_url('index.php/Sitranst/get_data_item'); ?>",
                     data: "searchbarcode="+searchbarcode,
                     cache:false,
                     success: function(data){
                       $('#tampilitem').html(data);
                     }
       ...
       <!-- form start -->
         ...
         <div class="box-body">
           <div class="form-group">
             ...
             <input onclick="LPS()" class="form-control col-md-6 col-xs-12" id="searchbarcode" value="" placeholder="Filter / Barcode" type="text" name="barcode" onkeypress="fireAjax();">
           </div>

           <div class="form-group">
             <div class="row">
                <div id="tampilitem"></div>
               <!-- /.col-lg-6 -->
               <div class="col-lg-1">
