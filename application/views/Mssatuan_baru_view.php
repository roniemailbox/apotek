    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Data satuan <?php echo $perintah ?></h3>
            </div>
                  <div class="box-body">

                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kode satuan <span class="required">*</span>
                    </label>
                    <div class="col-md-4 col-sm-6 col-xs-12">

                    <input style="background:#D9DCE8;" value=""  class="form-control col-md-4 col-xs-12" name="id_satuan" type="text" id="id_satuan" placeholder="AUTO" readonly/>
                    </div>
                  </div>
                             ...
                             <div class="form-group">
                                      ...
                                      <div class="col-md-8 col-sm-6 col-xs-12">
                                              <input class="form-control col-md-8 col-xs-12" id="nama" placeholder="Nama satuan" required type="text" name="nama">
                                      </div>
                             </div>
          ...
          <div class="box-header with-border">
            <h3 class="box-title">Data satuan <?php echo $perintah ?></h3>
                ...
                <div class="form-group">
                  ...
                  <input style="background:#D9DCE8;" value="<?php echo $row->id_satuan ?>"  class="form-control col-md-4 col-xs-12" name="id_satuan" type="text" id="id_satuan" placeholder="AUTO" readonly/>
                  </div>
                </div>
                           ...
                           <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                     <input class="form-control col-md-8 col-xs-12" id="nama" placeholder="Nama satuan" required type="text" name="nama" value="<?php echo $row->nama ?>">
                                    </div>
                           </div>
