...
<?php $action_form = 'Postrans/tambah'; ?>
...
<script type="text/javascript">
    ...
    function recounter()
    {
      ...
      if (j_ppn == "NON") {
          ...
          document.getElementById('grandtotalatas').value = formatRupiah(parseFloat(lblElement).toFixed(0));
        ...
        document.getElementById('grandtotalatas').value = formatRupiah(parseFloat(p+d).toFixed(0));
        //alert(e);
      }
    ...
    <script>
      function formatRupiah(angka){
        ...
        function hitung_pilih_item() {
          ...
          var res = document.getElementById("hb").value;
          /*menghilangkan karakter titik ([^\d]) pada inputan hb*/
          var hb = res.replace(/[^\d]/gi, "");
          ...
          if (e == "NON PPN") {
              dpp=(hb-diskon).toFixed(0);
              nilaippn=(0).toFixed(0);
              total=((hb-diskon)*qty).toFixed(0);

          }
          else {
              dpp=((hb-diskon)/1.1).toFixed(0);
              nilaippn=(10/100*dpp).toFixed(0);
              total=((hb-diskon)*qty).toFixed(0);
          }

         /* document.getElementById('coba').value = formatRupiah(total);*/
...
$("#add_btn_item").live('click', function() {
  $('#id_barang').val('');
  $('#nama_barang').val('');
  $('#qty').val(1);
  $('#hb').val(0);
...
<div class="content-wrapper">
   ...
   <section class="content-header">
     <h1>
       ...
       <!-- <input type="text" id="coba" name="coba"> -->
     </h1>
     <ol class="breadcrumb">
   ...
   <section class="content">
    <div class="box box-success bg-green" style="position: fixed; z-index:9999; width: 50%; margin-left: 15%">
       <div class="box-body form-horizontal">
          ...
          <div class="col-md-9">
            <div class="input-group">
               <div class="input-group-addon" style="font-size: 16px"><strong>Rp.</strong></div>
               <input class="form-control col-md-4 col-xs-12" type="text" style="text-align: right; color: blue; font-weight: bold; font-size: 60px; height: 60px" step="Any" id="grandtotalatas" name="grandtotalatas" readonly required />
            </div>
          </div>
       </div>
    </div>

     <div class="box box-default" style="margin-top: 10%">
       <div class="box-header with-border">
         <h3 class="box-title"><i class="fa fa-pencil-square-o"></i> Info PO</h3>
       ...
       <div class="box-body">
         ...
         <div class="col-md-8">
           <label>Cari Pelanggan<span class="required"></span> </label>
           <div class="input-group">
           <div class="input-group-addon">
             <i class="fa fa-ticket"></i>
           </div>
           ...
           <label>Customer </label>
              <div class="input-group">
                ...
                <input id="nama_customer" class="form-control col-md-3 col-xs-12" type="text" name="nama_customer" readonly>
              </div>
           <label>Alamat </label>
           <div class="input-group">
             <div class="input-group-addon">
             ...
             <input id="alamat_customer" class="form-control col-md-6 col-xs-12" type="text" name="alamat_customer" readonly>
           </div>
         </div>
       ...
       <div class="box-footer">
        ...
        <div class="col-lg-6 col-xs-6" hidden>
         <a href="<?php echo site_url('Postrans/cetak/'.$this->session->flashdata('no_penjuaan')); ?>" target="_blank" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Cetak Transaksi Terakhir <?php echo $this->session->flashdata('no_penjuaan') ?></a>
       </div>
       </div>
     </div>
         ...
         <div class="box-body">
             ...
             <div class="row">
                 <div class="col-lg-6">
                   <script type="text/javascript">
                           ...
                           $("#pbarcode").keyup(function(f) {
                              if (f.keyCode == 13) {
                               ...
                               if(value!=''){
                                ...
                                $.ajaxSetup({
                                  type:"POST",
                                  url: "<?php echo base_url('index.php/Postrans/ambil_data') ?>",
                                  cache: false,
                                });

                                    $.ajax({
                                      data:{modul:'scanbarcode',id:value},
                                      success: function(respond){
                                        var ss = respond.split("^");

                                        /*alert(respond);*/

                                        if (respond=='Data Tidak Ditemukan^^^^^^^'){
                                          alert("Data Tidak Ditemukan !!\nSilahkan cari di Filter Item..");
                                          document.getElementById("pbarcode").value='';
                                          document.getElementById("searchbarcode").value='';
                                          document.getElementById("searchbarcode").focus();
                                        } else {
                                          $("#kode_barang").val(ss[2]);
                                          $("#nama_barang").val(ss[1]);
                                          $("#hb").val(ss[3]);
                                          $("#satuan").val(ss[5]);
                                          $("#dpp").val(ss[4]);
                                          $("#ppn").val(ss[6]);
                       ...
                       <input onclick="iLPS();" class="form-control col-md-6 col-xs-12" id="pbarcode" value="" placeholder="Filter / Barcode" type="text" name="barcode">
                 </div>

                 <div class="col-lg-6">
                       <label for="exampleInputEmail1">Filter Item </label>
                       <input onclick="aLPS();" class="partsearch form-control col-md-6 col-xs-12" id="searchbarcode" value="" placeholder="Filter" type="text" name="barcode">
                 </div>
           </div>
           </div>
           ...
           <div class="form-group">
             <div class="row">
                ...
                <div class="col-lg-1">
                  <label>Qty</label>
                  <input name="qty" type="number" id="qty" class="form-control col-md-4 col-xs-12" style="text-align:right;" value="1" placeholder="Qty" onchange="hitung_pilih_item();" onblur="hitung_pilih_item();" onkeyup="hitung_pilih_item();" onkeypress="cek_qty()" />
                  <!-- /input-group -->
                </div>
                <div class="col-lg-2">
                  <label for="exampleInputEmail1">Harga Jual</label>
                  <input name="hb" type="text" id="hb" class="uang form-control col-md-4 col-xs-12" style="text-align:right;" value="<?php //echo $row->hj; ?>" placeholder="Harga Jual" onchange="hitung_pilih_item();" onblur="hitung_pilih_item();" />
                  <!-- /input-group -->
                </div>
                <div class="col-lg-1">
                ...
                <div class="col-lg-2">
                  <label for="exampleInputEmail1">Total</label>
                    <input name="total" type="text" id="total" class="form-control col-md-7 col-xs-12" value="0" style="text-align:right;" placeholder="Total" step="Any" readonly />
     ...
     <div class="row">
       ...
       <div class="col-md-12">
         <div class="box box-info">
             <div class="box-header with-border">
               <h3 class="box-title"><i class="fa fa-cubes"></i> Detail Item / Barang</h3>
               <div class="box-tools pull-right">
                 <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
               </div>
             </div>
                 ...
                 <div class="box-body">
                   ...
                   <div class="col-xs-12 table-responsive">
                      ...
                      <table class="table table-hover">
                        ...
                        <tfoot>
                          <tr>
                            <th style="width:5%; text-align:center;"><input style="text-align:center" type="hidden" class="form-control" id="key_max" value="0" style="background-color:#eea236; color:black;" hidden/></th>
                            ...
                            <th style="width:5%; text-align:center;"></th>
                            <th style="width:17%; text-align:center;"><input style="text-align:right" class="form-control" type="hidden" id="SUM3" value="<?php //echo $totalJual; ?>" name="SUM3" readonly /> </td></th>
       											<th style="width:5%; text-align:center;"></th>
                          </tr>
                        </tfoot>
     										</table>
                 ...
                 <div class="box-body">
                   <div class="col-md-6">
                     <label>Keterangan</label>
                         ...
                         <textarea class="form-control" rows="3" name="keterangan" placeholder="Isikan Note Disini ..." onblur="recounter();" onmouseover="recounter();"></textarea>
                   ...
                   <div class="col-md-6">
                     ...
                     <input style="text-align:right" id="totalTot" class="form-control" value="0" type="number" name="subtotal" readonly>
                     <label> Dpp </label>
                     ...
                     <script type="text/javascript">
                         $(document).ready(function() {
                                /* $("#jml_bayar").change(function(){
                                   ...
                                   var xxjml_bayar = parseFloat(document.getElementById("jml_bayar").value.replace(/[^\d]/gi,""));
                                   var xxkembalian=xxjml_bayar-xxgrandtotal;

                                   document.getElementById('jml_kembali').value = formatRupiah(xxkembalian);
                                 });*/
                           ...
                           $("#jml_bayar").keyup(function(e) {
                            /*if (e.keyCode == 13) {*/
                               ...
                               if (xxjml_bayar > xxgrandtotal) {
                                  document.getElementById('jml_kembali').value = formatRupiah(xxkembalian);
                               } else {
                                  document.getElementById('jml_kembali').value = '0';
                               }
                     ...
                     <input style="text-align:right; padding-right: 30px" id="jml_bayar" class="uang form-control" type="text" step="Any" name="jml_bayar" required>
                     <label> Kembalian </label>
                     <input style="text-align:right; padding-right: 30px" id="jml_kembali" class="form-control" type="text" step="Any" name="jml_kembali" readonly required>
                   ...
                   <div class="box-footer">
                    <div class="col-lg-12 col-xs-6">
                     ...
                     <button id="btnSubmit" type="submit" class="btn btn-success"><i class="fa fa-save"></i> Simpan</button>
                   </div>
                   </div>
                 </div>
