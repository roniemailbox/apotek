...
<?php $action_form = 'Buatresep/tambah'; ?>
                           ...
                           $("#pbarcode").keyup(function(e) {
                              if (e.keyCode == 13) {
                               var value=$(this).val();
                                ...
                                $.ajaxSetup({
                                  type:"POST",
                                  url: "<?php echo base_url('index.php/Buatresep/ambil_data') ?>",
                                  cache: false,
                                });
                                  ...
                                  if(value!==null){
                                    $.ajax({
                                      ...
                                      success: function(respond){
                                        ...
                                        if (respond[1]!='<'){
                                          $("#kode_barang").val(ss[0]);
                                          $("#nama_barang").val(ss[1]);
                                          $("#hb").val(ss[2]);
                                          $("#satuan").val(ss[3]);
                                          document.getElementById("qty").focus();
                                        } else {
                                          alert("Cari di Filter Barang");
               ...
               //myFunctionZ();
                 ...
                 <div class="box-body">
                   ...
                   <div class="col-md-6">
                     ...
                     <input style="text-align:right" id="jml_bayar" class="form-control" type="number" step="Any" name="jml_bayar"  required>
                     <label> Kembalian </label>
                     <input style="text-align:right" id="jml_kembali" class="form-control" type="number" step="Any" name="jml_kembali" readonly required>
                   -->

                   <label hidden> Aktif </label>
                   <input style="text-align:right" id="status_aktif" class="form-control" value="" placeholder="AUTO" name="status_aktif" type="hidden" readonly>
