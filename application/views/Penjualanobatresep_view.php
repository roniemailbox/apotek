...
<?php $action_form = 'Obatresep/tambah'; ?>
   ...
   <section class="content">
     ...
     <div class="box box-default">
       ...
       <div class="box-header with-border">
         <h3 class="box-title"><i class="fa fa-pencil-square-o"></i> Info Penjualan</h3>
       ...
       <div class="box-body">
         <?php
            ...
            if(isset($data_judul_resep))
               {
                 foreach ($data_judul_resep as $xrow)
                    {
                      ?>
         <div class="col-md-2">
           ...
           <div class="input-group">
             ...
             <input class="form-control col-md-4 col-xs-12" value="<?php echo $xrow->no_bukti; ?>" placeholder="AUTO" readonly type="text" name="no_resep" >
             <input class="form-control col-md-4 col-xs-12" value="<?php echo $xrow->no_ref; ?>" placeholder="AUTO" readonly type="hidden" name="no_wo" >
           </div>
           <label>Ppn</label>
             <div class="input-group">
       ...
       <?php }} ?>
         <div class="col-md-4">
           <label>Pencarian Cust<span class="required"></span>
           </label>
           <div class="input-group">
             <div class="input-group-addon">
           ...
           <label>ID Cust / RM </label>
              <div class="input-group">
                <div class="input-group-addon">
                  <i class="fa fa-info"></i>
                </div>
                <input id="npa" class="form-control col-md-3 col-xs-12" value="<?php echo $xrow->no_register_px; ?>" type="text" name="npa" readonly>
              </div>
           <label>Customer / Pasien </label>
           <div class="input-group">
             <div class="input-group-addon">
               <i class="fa fa-info"></i>
             </div>
             <input id="nama" class="form-control col-md-6 col-xs-12" value="<?php echo $xrow->nama; ?>" type="text" name="nama" readonly>
           </div>
           <label>Dokter </label>
           <div class="input-group">
             <div class="input-group-addon">
             ...
             <input class="form-control col-md-6 col-xs-12" value="<?php echo $xrow->id_dokter; ?>" type="hidden" name="id_dokter" readonly>
             <input class="form-control col-md-6 col-xs-12" value="<?php echo $xrow->nama_dokter; ?>" type="text" name="nama_dokter" readonly>
           </div>
         </div>
         <div class="col-md-6">
           <label>Total </label>
       ...
       <div class="box-footer">
        ...
        <div class="col-lg-6 col-xs-6">
         <a href="<?php echo site_url('Sitranspfarm/cetak/'.$this->session->flashdata('no_penjuaan')); ?>" target="_blank" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Cetak Transaksi Terakhir <?php echo $this->session->flashdata('no_penjuaan') ?></a>
       </div>
       </div>
     </div>
     <script>
     ...
     function fireAjax(){
                 ...
                 $.ajax({
                     url: "<?php echo base_url('index.php/Sitranspfarm/get_data_item'); ?>",
                     type:"POST",
       ...
       <div class="box-header with-border">
         ...
         <div class="box-body">
           ...
           <div class="form-group">
             <label for="exampleInputEmail1">Filter Item / Obat</label>
           ...
           <div class="form-group">
             <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  <input name="nama_barang" type="text" id="nama_barang" value="<?php //echo $row->nama; ?>" class="form-control col-md-7 col-xs-12"  placeholder="Nama Obat" readonly>
                  <!-- /input-group -->
                </div>
                <div class="col-lg-1">
                  <label>Qty</label>
           ...
           <script type="text/javascript" src='<?php echo base_url();?>assets/js/append_item_jual_obatresep.js'></script>
                   ...
                   <div class="col-xs-12 table-responsive">
                      ...
                      <table class="table table-hover">
                        <!--  <table id="example_detail" class="table table-bordered table-striped nowrap"  cellspacing="0" width="100%"> -->
                          ...
                          <th style="width:7%; text-align:center;">Harga</th>
                          <th style="width:8%; text-align:center;">Total</th>
                          <th style="width:8%; text-align:center;">Keterangan</th>
                         ...
                         <tbody id="containeritem" style="height: 100px; overflow: auto;">
                           <?php
                             ...
                             $totalbeli=0;
                             $totaldiskon=0;
                              if(isset($data_detail_resep))
                                 {
                                   foreach ($data_detail_resep as $row)
                                      { $count++;
                                        $qty=$qty+$row->qty;
                                        $totalbeli=$totalbeli+($row->qty*$row->hj);
                                        //$totaldiskon=$totaldiskon+($row->qty*$row->diskon);
                                          ?>

                                          <tr class="records">
                                            <td align="center">
                                              <div hidden id="count"><?php echo ($count) ?></div>
                                              <input class="form-control col-md-7 col-xs-12" style="width:100%; text-align:left" type="text" value="<?php echo $count; ?>" readonly />
                                            </td>
                                            ...
                                            <td>
                                              ...
                                              <input class="form-control col-md-7 col-xs-12" style="width:100%" id="id_barang_<?php echo ($count) ?>" name="id_barang_<?php echo ($count) ?>" type="hidden" value="<?php echo $row->id_barang; ?>" readonly />
                                            </td>
                                            <td>
                                              <input class="form-control col-md-7 col-xs-12" style="width:100%" id="satuan_<?php echo ($count) ?>" name="satuan_<?php echo ($count) ?>" type="text" value="<?php echo $row->satuan; ?>" readonly />
                                            </td>

                                            <td>
                                            <span class="nilaiQty" hidden><?php echo $row->qty; ?></span>
                                            <input class="form-control col-md-7 col-xs-12" style="width:100%; text-align:center" id="qty_<?php echo ($count) ?>" name="qty_<?php echo ($count) ?>" type="number" value="<?php echo $row->qty; ?>" onchange="recounter();" onblur="recounter();" />
                                            </td>
                                            <td>

                                            <input class="form-control col-md-7 col-xs-12" style="width:100%; background:#BBECBE; text-align:right" id="hj_<?php echo ($count) ?>" name="hj_<?php echo ($count) ?>" type="number" value="<?php echo $row->hj; ?>" onchange="recounter();" onblur="recounter();" />

                                            </td>


                                             <td>
                                            <span class="nilaiTotal" hidden><?php echo ($row->qty*$row->hj); ?></span>
                                            <input class="form-control col-md-7 col-xs-12" style="width:100%; text-align:right " id="total_<?php echo ($count) ?>" name="total_<?php echo ($count) ?>" type="number" value="<?php echo $row->qty*$row->hj; ?>" readonly />
                                            </td>
                                            <td>
                                           <span class="nilaiTotal" hidden><?php echo ($row->qty*$row->hj); ?></span>
                                           <input class="form-control col-md-7 col-xs-12" style="width:100%; text-align:right " id="keterangan_<?php echo ($count) ?>" name="keterangan_<?php echo ($count) ?>" type="text" value="<?php echo $row->keterangan; ?>" />
                                           </td>
