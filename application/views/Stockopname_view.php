       ...
       <div class="col-xs-12">
         ...
         <div class="box">
          ...
          <div class="box-header">
               ...
               <a href="<?php echo site_url('Stockopname/baru'); ?>" class="btn btn-block btn-primary btn-flat"><i class="fa fa-plus-square-o"></i> Buat Opname</a>
           ...
           <div class="modal fade" id="modal-default">
             <div class="modal-dialog">
               <div class="modal-content">
                 <form class="form-horizontal" method="post" action="<?php echo site_url('Stockopname/filter')?>">
