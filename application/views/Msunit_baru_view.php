...
<?php
if ($perintah=="Baru"){
  $action_form = 'Msunit/tambah';
}
else {
  $action_form = 'Msunit/edit';
}
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Data unit <?php echo $perintah ?></h3>
            </div>
                  <div class="box-body">

                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kode Unit <span class="required">*</span>
                              </label>
                              <div class="col-md-4 col-sm-6 col-xs-12">

                              <input style="background:#D9DCE8;" value=""  class="form-control col-md-4 col-xs-12" name="id_unit" type="text" id="id_unit" placeholder="AUTO" readonly/>
                              </div>
                            </div>
                             ...
                             <div class="form-group">
                                      ...
                                      <div class="col-md-8 col-sm-6 col-xs-12">
                                              <input class="form-control col-md-8 col-xs-12" placeholder="Nama unit" required type="text" name="nama_unit">
                                      </div>
                             </div>
                             ...
                             <div class="form-group">
                               ...
                               <div class="col-md-8 col-sm-6 col-xs-12">
                                 <textarea id="alamat" placeholder="Alamat" class="form-control" name="alamat_unit" ><?php  //echo $row->alamat; ?></textarea>
                               </div>
                             </div>
                             <div class="form-group">
                               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Kota
                                 ...
                                 <div class="col-md-8 col-xs-12">
                                   <select class="form-control select2 col-md-12" name="id_kabupaten">
                             ...
                             <div class="form-group">
                               <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Perusahaan
                               </label>

                                 <div class="col-md-8 col-xs-12">
                                   <select class="form-control select2 col-md-12" name="id_perusahaan">
                                      <option value="<?php //echo $row->id_kota ?>"><?php echo "-- Pilih --" ?></option>
                                     <?php foreach ($data_perusahaan as $dt_per)
                                     {
                                       echo '<option value="'.$dt_per->id_perusahaan.'">'.$dt_per->nama.'</option>';
                                     }
            ...
            <h3 class="box-title">Data unit <?php echo $perintah ?></h3>
                ...
                <div class="box-body">
                          ...
                          <div class="form-group">
                            ...
                            <input style="background:#D9DCE8;" class="form-control col-md-4 col-xs-12" value="<?php echo $row->kd_unit; ?>" name="id_unit" type="text" placeholder="AUTO" readonly/>
                            </div>
                          </div>
                           ...
                           <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-8 col-xs-12" value="<?php   echo $row->nama_unit; ?>" placeholder="Nama unit" required type="text" name="nama_unit">
                                    </div>
                           </div>
                           ...
                           <div class="form-group">
                             ...
                             <div class="col-md-8 col-sm-6 col-xs-12">
                               <textarea id="alamat" placeholder="Alamat" class="form-control" name="alamat_unit" ><?php   echo $row->alamat_unit; ?></textarea>
                             </div>
                           </div>
                           <div class="form-group">
                             <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Kota
                               ...
                               <div class="col-md-8 col-xs-12">
                                 <select class="form-control select2 col-md-12" name="id_kabupaten">
                                    <option value="<?php echo $row->id_kabupaten ?>"><?php echo $row->nama_kota ?></option>
                                   <?php foreach ($data_kabupaten as $dt_kab)
                                   {
                                     echo '<option value="'.$dt_kab->id.'">'.$dt_kab->name.'</option>';
                                   }
