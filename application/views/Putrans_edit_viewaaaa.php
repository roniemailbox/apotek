...
<script type="text/javascript">
    ...
    <script type="text/javascript" src='<?php echo base_url();?>assets/js/append_part_Pu.js'></script>
    <script type="text/javascript">
...
<form name="form1" id="form1" method="Pust" action="<?=site_url($action_form)?>"  enctype="multipart/form-data" onkeypress="return event.keyCode != 13;" >
   ...
   <section class="content">
     ...
     <div class="box box-default">
       ...
       <div class="box-header with-border">
         <h3 class="box-title"><i class="fa fa-pencil-square-o"></i> Info Pu</h3>
   ...
   if(isset($data_edit)){
     foreach($data_edit as $row){
       ...
       <div class="box-body">
         ...
         <div class="col-md-8">
           <label>Cari Supplier<span class="required"></span> </label>
           <div class="input-group">
           <div class="input-group-addon">
             <i class="fa fa-ticket"></i>
           </div>

           <select class="select2 form-control" id="id_supplier" name="id_supplier" onchange="onklik(this.value)" required>
            <option value="<?php echo $row->id_supplier; ?>"><?php echo $row->nama_supplier; ?></option>
            <?php
            $jsArray2 = "var kdSertifikat2 = new Array();\n";
            foreach ($data_supplier as $rowq) {
               $xxalamat=$rowq->alamat;
               echo '<option value="'.$rowq->id_supplier.'">'.$rowq->nama.'</option>';
               $jsArray2 .= "kdSertifikat2['".$rowq->id_supplier."'] = {
                 data11:'".$rowq->nama."',
                 data21:'".$rowq->telePun."',
                 data31:'".$xxalamat."'
                 };\n";
           ...
           <?php echo $jsArray2; ?>
           function onklik(idx){
               var x = document.getElementById("id_supplier").selectedIndex;
               var combo2 = document.getElementById("id_supplier").value;
               //alert(combo2);
               if (combo2 === 'pilih'){
                 document.getElementById('nama_supplier').value = '';
                 //document.getElementById('telePun_supplier').value = '';
                 document.getElementById('alamat_supplier').value = '';
                 //alert("NAY");
                 return false;
               } else {
                 document.getElementById('nama_supplier').value = kdSertifikat2[idx].data11;
                 //document.getElementById('telePun_supplier').value = kdSertifikat2[idx].data21;
                 document.getElementById('alamat_supplier').value = kdSertifikat2[idx].data31;
                 //document.getElementById('telePun_customer').value = CustSertifikat[idx].data31;
                 //alert("YAI");
                 return false;
               }
           ...
           <label>Supplier </label>
              <div class="input-group">
                ...
                <input id="nama_supplier" value="<?php echo $row->nama_supplier; ?>" class="form-control col-md-3 col-xs-12" type="text" name="nama_supplier" readonly>
              </div>
           <label>Alamat </label>
           <div class="input-group">
             <div class="input-group-addon">
             ...
             <input id="alamat_supplier" value="<?php echo $row->alamat_supplier; ?>" class="form-control col-md-6 col-xs-12" type="text" name="alamat_supplier" readonly>
           </div>
         </div>
   ...
   <?php } } ?>
       ...
       <div class="box-footer">
        ...
        <div class="col-lg-6 col-xs-6" hidden>
         <a href="<?php echo site_url('Putrans/cetak/'.$this->session->flashdata('no_penjuaan')); ?>" target="_blank" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Cetak Transaksi Terakhir <?php echo $this->session->flashdata('no_penjuaan') ?></a>
       </div>
       </div>
     </div>
       ...
       <div class="box-header with-border">
         ...
         <div class="box-body">
           ...
           <div class="form-group">
             ...
             <input onclick="LPS();" class="partsearch form-control col-md-6 col-xs-12" id="searchbarcode" value="" placeholder="Filter / Barcode" type="text" name="barcode">
           </div>
           ...
           <div class="form-group">
             <div class="row">
                ...
                <div class="col-lg-2">
                  ...
                  <input name="hb" type="text" id="hb" class="form-control col-md-4 col-xs-12" style="text-align:right;" value="<?php //echo $row->hj; ?>" placeholder="Harga Beli" onchange="hitung_pilih_item();" onblur="hitung_pilih_item();" />
                  <!-- /input-group -->
                </div>
                <div class="col-lg-1">
     ...
     <!-- form start -->
                 ...
                 <div class="box-body">
                   ...
                   <div class="col-xs-12 table-resPunsive">
                      ...
                      <table class="table table-hover">
                        ...
                        <tfoot>
                          <tr>
                            <th style="width:5%; text-align:center;"><input style="text-align:center" type="hidden" class="key_max" id="key_max" value="<?php echo ($count) ?>" style="background-color:#eea236; color:black;" hidden/></th>
