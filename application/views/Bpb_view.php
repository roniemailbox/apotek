       ...
       <div class="col-xs-12">
         ...
         <div class="box">
          ...
          <div class="box-header">
            ...
            if($hak_c == 1)
            { ?>
               <a href="<?php echo site_url('Bpb/baru'); ?>" class="btn btn-block btn-primary btn-flat"><i class="fa fa-plus-square-o"></i> Input Baru</a>
            <?php }
            if($hak_r == 1)
            { ?>
           ...
           <div class="modal fade" id="modal-default">
             <div class="modal-dialog">
               <div class="modal-content">
                 <form class="form-horizontal" method="post" action="<?php echo site_url('Bpb/filter')?>">
        ...
        foreach ($data_bpb as $row)
           ...
           <td>
             ...
             if($hak_u == 1)
             {
               ...
               {
                  ?>
                  <a href="<?php echo site_url('Bpb/ambil_edit/'.$row->no_bukti);?>" class="btn btn-info btn-xs"
             ...
             if($hak_d == 1)
             {
               ...
               {
                  ?>
                  <a href="<?php echo site_url('Bpb/hapus/'.$row->no_bukti);?>" class="btn btn-danger btn-xs"
             ...
             {
               ?>
               <a href="<?php echo site_url('Bpb/cetak/'.$row->no_bukti);?>" class="btn btn-success btn-xs" target="_blank"> <i class="fa fa-print"></i> Cetak</a>
             <?php
             }
