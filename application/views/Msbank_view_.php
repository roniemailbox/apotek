         ...
         <div class="row">
           <div class="col-md-12">
            ...
            <label>KD Akun</label>
             <div class="input-group">
               <span class="input-group-addon"><i class="fa fa-credit-card"></i></span>
               <input type="text" class="form-control" name="kd_akun" placeholder="Kode Akun">
            </div>
      ...
      <div class="row">
        ...
        <label>Nama Bank</label>
            ...
            <label>KD Akun</label>
             <div class="input-group">
               <span class="input-group-addon"><i class="fa fa-credit-card"></i></span>
               <input type="text" class="form-control" name="kd_akun" value="<?php echo $row_edit->kd_akun ?>" placeholder="AUTO" readonly>
            </div>
