         ...
         <div class="row">
           <div class="col-md-6">
             ...
             <div class="input-group">
               ...
               <input type="text" class="form-control" name="kd_akun" placeholder="Kode Akun (CoA)">
             </div>
             <label>Induk</label>
             <div class="input-group">
    ...
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-key"></i></span>
            <input type="text" class="form-control"  value="<?php echo $row_edit->kd_akun; ?>"  name="kd_akun" placeholder="Input No Rekam Medik">
          </div>
