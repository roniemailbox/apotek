...
<div class="box box-default">
  ...
  <div class="box-body">
      ...
      <label>Kode Barang</label>
        <div class="input-group">
          <span class="input-group-addon"><i class="fa fa-key"></i></span>
            <input type="text" class="form-control" name="id_barang" placeholder="Auto" readonly>
        </div>
    ...
    <div class="col-md-6">
      ...
      <label>Satuan Terbesaar</label>
      <div class="input-group">
        <span class="input-group-addon"><i class="fa fa-ellipsis-v"></i></span>
          <select class="select2 form-control" name="satuan_besar" required>
            <option value="">-- Pilih --</option>
            <?php foreach ($data_satuan2 as $row)
              {
                echo '<option value="'.$row->id_satuan.'">'.$row->nama.'</option>';
              }
            ?>
      ...
      <div class="input-group">
        <span class="input-group-addon"><i class="fa fa-money"></i></span>
          <input class="form-control" type="number" name="konversi" placeholder="konversi">
      </div> 
  ...
  <?php
    ...
    <div class="row">
      ...
      <label>Kode Barang</label>
        <div class="input-group">
          <span class="input-group-addon"><i class="fa fa-key"></i></span>
            <input style="background:#D9DCE8;" type="text" class="form-control" value="<?php echo $row_edit->id_barang; ?>" name="id_barang" placeholder="Input Kode Barang">
        </div>

        <label>Barcode</label>
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-barcode"></i></span>
              <input type="text" class="form-control" name="barcode" placeholder="Barcode" value="<?php echo $row_edit->barcode?>">
          </div>
        ...
        <div class="input-group">
          <span class="input-group-addon"><i></i></span>
            <input type="text" class="form-control" name="nama" placeholder="Nama Produk" value="<?php echo $row_edit->nama_barang ?>">
        </div>

        <label>Nama Alias</label>
          <div class="input-group">
            <span class="input-group-addon"><i></i></span>
              <input type="text" class="form-control" name="nama_alias" placeholder="Nama Alias" value="<?php echo $row_edit->nama_alias ?>">
          </div>
          ...
          <label>PPN</label>
            <div class="input-group">
              <span class="input-group-addon"><i class="fa fa-credit-card"></i></span>
                <select class="select2 form-control" name="ppn" required>
                  <option value="<?php echo $row_edit->ppn ?>"><?php echo $row_edit->ppn ?></option>
                  <option value="PPN">PPN</option>
                  <option value="NON PPN">NON PPN</option>
                </select>
            </div>
            ...
            <div class="input-group">
              <span class="input-group-addon"><i class="fa fa-ellipsis-v"></i></span>
                <select class="select2 form-control" name="id_kategori" required>
                  ...
                  <option value="<?php echo $row_edit->id_kategori ?>"><?php echo $row_edit->nama_kategori ?></option>
          ...
          <label>Merk</label>
            <div class="input-group">
              ...
              <select class="select2 form-control" name="id_merk" >
                <option value="<?php echo $row_edit->id_merk ?>"><?php echo $row_edit->nama_merk ?></option>
                <?php foreach ($data_merk as $rowsc)
                {
                  echo '<option value="'.$rowsc->id_merk.'">'.$rowsc->nama.'</option>';
                }
                ?>
                </select>
            </div>
          ...
          <label>Jenis</label>
            <div class="input-group">
              ...
              <select class="select2 form-control" name="id_jenis">
                <option value="<?php echo $row_edit->id_jenis ?>"><?php echo $row_edit->nama_jenis ?></option>
                <?php foreach ($data_jenisx as $rowsca)
                {
                  echo '<option value="'.$rowsca->id_jenis.'">'.$rowsca->nama.'</option>';
                }
                ?>
                </select>
            </div>
    ...
    <label>Tipe</label>
      <div class="input-group">
        ...
        <select class="select2 form-control" name="id_tipe">
           <option value="<?php echo $row_edit->id_tipe ?>"><?php echo $row_edit->nama_tipe ?></option>
    ...
    <div class="col-md-6">
      ...
      <div class="input-group">
        <span class="input-group-addon"><i class="fa fa-ellipsis-v"></i></span>
          <select class="select2 form-control" name="id_satuan" required>
          <option value="<?php echo $row_edit->id_satuan ?>"><?php echo $row_edit->nama_satuan ?></option>
      ...
      <div class="input-group">
        <span class="input-group-addon"><i class="fa fa-ellipsis-v"></i></span>
          <select class="select2 form-control" name="satuan_besar" required>
          <option value="<?php echo $row_edit->satuan_besar ?>"><?php echo $row_edit->nama_satuan2 ?></option>
           <?php foreach ($data_satuan2 as $rowgh)
           {
             echo '<option value="'.$rowgh->id_satuan.'">'.$rowgh->nama.'</option>';
           }
           ?>
          </select>
      </div>
      ...
      <div class="input-group">
        <span class="input-group-addon"><i class="fa fa-money"></i></span>
          <input class="form-control" type="number" value="<?php echo $row_edit->konversi; ?>" name="konversi" placeholder="konversi">
      </div>
          ...
          <?php //include 'template/Pesan.php'; ?>
           <div class="box-header">
             <button type="button" class="btn btn-block btn-info btn-dropbox" data-toggle="modal" data-target="#modal-default"><i class="fa fa-search"></i>
               Cari Master Barang (<?php foreach ($jml_item as $row_jml) { echo $row_jml->jumlah_item;  } ?> Item di Database)
             </button>

             <button type="button" class="btn btn-block btn-info btn-flat" ><i class="fa fa-file-excel-o"></i>
             <a href="<?php echo site_url('Msbarang/exportexcel'); ?>" >Download Excel Master Barang </a>
             </button>
           </div>
                 ...
                 <div class="modal-body">
                  <p>
                     ...
                     <div class="input-group">
                       ...
                       <span class="input-group-addon"><i class="fa fa-ellipsis-v"></i></span>
                       <input type="text" value="<?php echo $row->nama_barang; ?>" class="form-control" placeholder="RW" readonly>
                     </div>
                  </p>
                 </div
                 >
