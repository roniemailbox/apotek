    ...
    foreach ($data_wo as $row)
       { ?>
         ...
         <div class="modal fade" id="modal-preview<?php echo $row->no_bukti; ?>">
           <div class="modal-dialog">
             <div class="modal-content">
               <form class="form-horizontal" method="post" target="_blank" action="<?php echo site_url('Obatresep/Cetakresep')?>">
               <div class="modal-header">
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                   <span aria-hidden="true">&times;</span></button>
                 <h4 class="modal-title">Cetak Resep Ini....????</h4>
               </div>
               <div class="modal-body">
                 <p>
                   <h5>No Resep</h5>
                   ...
                   <div class="input-group">
                     ...
                     <span class="input-group-addon"><i class="fa fa-key"></i></span>
                     <input type="text" name="no_bukti" value="<?php echo $row->no_bukti; ?>" class="form-control" placeholder="No Resep" readonly>
                   </div>
                   <h5>Nama Pasien</h5>
         ...
         <div class="modal fade" id="modal-obat<?php echo $row->no_bukti; ?>">
           <div class="modal-dialog">
             <div class="modal-content">
               <form class="form-horizontal" method="post" action="<?php echo site_url('Obatresep/Ambilobat')?>">
               <div class="modal-header">
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                   <span aria-hidden="true">&times;</span></button>
                 <h4 class="modal-title">Melakukan Penjualan Obat Resep....????</h4>
               </div>
               <div class="modal-body">
                 <p>
                   <h5>No Resep</h5>
                   ...
                   <div class="input-group">
                     ...
                     <span class="input-group-addon"><i class="fa fa-key"></i></span>
                     <input type="text" name="no_resep" value="<?php echo $row->no_bukti; ?>" class="form-control" placeholder="Auto" readonly>
                   </div>
                   <h5>Nama Pasien</h5>
