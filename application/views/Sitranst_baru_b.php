...
<form class="form-horizontal form-label-left" name="form1" method="post" action="<?=site_url($action_form)?>"  enctype="multipart/form-data" onkeypress="return event.keyCode != 13;" >
         ...
         <div class="form-group">
            <div class="col-lg-12 col-xs-6">
               <div class="small-box bg-green">
                       <div class="inner">
                         <p>Tekan (F7) untuk simpan transaksi</p>
          ...
          <div class="row invoice-info">
            ...
            <div class="col-sm-5 invoice-col">
             ...
             <div class="form-group">
               ...
               <input onclick="LPS()" style="background:#ffa3a3;" class="partsearch form-control col-md-12 col-xs-12" name="filterbarang" type="text" id="filterbarang" placeholder="Pencarian Barang" onkeypress="cek_item()"/>
             </div>
             </div>
          ...
          <div class="col-sm-2 invoice-col">
             ...
             <div class="form-group">
               ...
               function recounter()
               {
                 ...
                 document.getElementById('lblTotal').innerHTML = localeFormat(lblElement);
