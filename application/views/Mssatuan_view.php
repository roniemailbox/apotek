         ...
         <div class="row">
           <div class="col-md-12">
             ...
             <div class="input-group">
               ...
               <input type="text" class="form-control" name="id_satuan" placeholder="Kode Satuan">
             </div>
    ...
    <div class="box-body">
      ...
      <div class="row">
        ...
        <label>Kode Satuan</label>
             <div class="input-group">
               <span class="input-group-addon"><i class="fa fa-key"></i></span>
               <input type="text" class="form-control" name="id_satuan" value="<?php echo $row_edit->id_satuan ?>" placeholder="AUTO" readonly>
             </div>
