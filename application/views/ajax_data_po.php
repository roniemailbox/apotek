...
<div class="box-body">
  <div class="col-md-4">
    ...
    <div class="input-group">
      ...
      <input class="form-control col-md-4 col-xs-12" value="<?php //echo $row->no_bukti; ?>" placeholder="No Referensi" type="text" name="no_ref" >
    </div>
...
<div class="box-footer">
 ...
 <div class="col-lg-6 col-xs-6" hidden>
  <a href="<?php echo site_url('Potrans/cetak/'.$this->session->flashdata('no_penjuaan')); ?>" target="_blank" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Cetak Transaksi Terakhir <?php echo $this->session->flashdata('no_penjuaan') ?></a>
</div>
</div>
</div>
          ...
          <div class="box-body">
            ...
            <div class="col-xs-12 table-responsive">
               ...
               <table class="table table-hover">
                 ...
                 <tfoot>
                   <tr>
                     <th style="width:5%; text-align:center;"><input style="text-align:center" type="hidden" class="key_max" id="key_max" value="<?php echo ($count) ?>" style="background-color:#eea236; color:black;" shidden/></th>
