            ...
            jq_auto(function(){
              ...
              jq_auto('.ktpsearch').autocomplete({
                ...
                onSelect: function (suggestion) {
                  jq_auto('#ktp_jasa').val(''+suggestion.ktp);
...
<script type="text/javascript">
    ...
    function LPSktp() {
      ...
      document.getElementById('ktp_jasa').value='';
         ...
         <div class="box box-info">
           ...
           <div class="box-body">
             ...
             <div class="input-group">
               ...
               <span class="input-group-addon"><i class="fa fa-ellipsis-v"></i></span>
               <input type="number" class="form-control" name="nilai" placeholder="Nilai Jasa" required>
             </div>
       ...
       <div class="box box-info">
         ...
         <?php
           ...
           <div class="input-group">
             ...
             <span class="input-group-addon"><i class="fa fa-ellipsis-v"></i></span>
             <input type="text" value="<?php echo $row_edit->jasa; ?>" name="nama" class="form-control" placeholder="jasa" required>
           </div>
           <h5>Nilai Jasa</h5>
           ...
           <div class="input-group">
             ...
             <span class="input-group-addon"><i class="fa fa-ellipsis-v"></i></span>
             <input type="number" value="<?php echo $row_edit->nilai; ?>" class="form-control" name="nilai" placeholder="Nilai Jasa" required>
           </div>
 ...
 if(isset($data_jasa))
    {
      foreach ($data_jasa as $row)
         { ?>
           ...
           <td align="Right"><?php echo number_format($row->nilai); ?></td>
