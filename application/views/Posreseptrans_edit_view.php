...
<?php $action_form = 'Postrans/simpan_resep'; ?>
...
<div class="content-wrapper">
   ...
   <section class="content">
     ...
     <div class="input-group" hidden>
       ...
       <input id="middle-name" class="date-picker form-control col-md-3 col-xs-12" value="<?php echo $no_cb; ?>" type="hidden" name="no_cb" required>
     </div>
     ...
     <div class="box box-default">
       ...
       <div class="box-header with-border">
         <h3 class="box-title"><i class="fa fa-pencil-square-o"></i> Info Penjualan Obat Resep</h3>
       ...
       <div class="box-body">
         <div class="col-md-4">
           ...
           <div class="input-group">
             ...
             <input class="form-control col-md-4 col-xs-12" value="<?php echo $row->no_bukti; ?>" placeholder="AUTO" readonly type="text" name="no_ref" >
             <input class="form-control col-md-4 col-xs-12" value="<?php echo $row->no_ref; ?>" placeholder="AUTO" readonly type="ahidden" name="no_rm" >
             <input class="form-control col-md-4 col-xs-12" value="<?php echo $row->tipe_wo; ?>" placeholder="AUTO" readonly type="ahidden" name="tipe_wo" >
             <input class="form-control col-md-4 col-xs-12" value="<?php echo $row->nama_jenis; ?>" placeholder="AUTO" readonly type="ahidden" name="nama_jenis" >
           </div>
            ...
            <label>Pembayaran</label>
             ...
             <div class="input-group">
               ...
               <input id="middle-name" class="date-picker form-control col-md-3 col-xs-12" value="<?php echo $row->nama_dokter; ?>" type="text" name="nama_dokter" required>
             </div>
