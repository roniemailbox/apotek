...
<?php $action_form = 'Putranspo/simpan_edit'; ?>
   ...
   <section class="content">
     ...
     <div class="box box-default">
       ...
       <div class="box-header with-border">
         <select class="select2 form-control" id="no_po" name="no_po" disabled>
       ...
       <div class="box-body">
         <div class="col-md-4">
           ...
           <div class="input-group">
             ...
             <input class="form-control col-md-4 col-xs-12" value="<?php echo $row->no_ref; ?>" placeholder="AUTO" readonly type="text" name="no_ref" >
             <input class="form-control col-md-4 col-xs-12" value="<?php echo $row->no_bukti; ?>" placeholder="AUTO" readonly type="hidden" name="no_bukti" >
           </div>
         ...
         <div class="col-md-8">
           ...
           function onklik(idx){
               ...
               if (combo2 === 'pilih'){
                 ...
                 //document.getElementById('telepon_supplier').value = kdSertifikat2[idx].data21;
   ...
   <?php } } ?>
       ...
       <div class="box-footer">
        ...
        <div class="col-lg-6 col-xs-6" hidden>
         <a href="<?php echo site_url('Putranspo/cetak/'.$this->session->flashdata('no_penjuaan')); ?>" target="_blank" class="btn btn-danger pull-right"><i class="fa fa-print"></i> Cetak Transaksi Terakhir <?php echo $this->session->flashdata('no_penjuaan') ?></a>
       </div>
       </div>
     </div>
