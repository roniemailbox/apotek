  ...
  <?php if($perintah=="Baru")
  {
    ?>
     ...
     <div class="row">
       ...
       <div class="col-md-6">
         <div class="box box-info">
             <div class="box-header with-border">
               <h3 class="box-title">Data Customer <?php echo $perintah ?></h3>
             </div>
     <!-- /.box-header -->
     <!-- form start -->
                 ...
                 <div class="box-body">
                   <div class="form-group">
                     ...
                     <input class="form-control col-md-4 col-xs-12"  name="id_customer" type="text" value="<?php //echo $row->id_customer; ?>" id="id_customer" placeholder="AUTO" readonly />
                     </div>
                   </div>
                              ...
                              <div class="form-group">
                                       ...
                                       <div class="col-md-8 col-sm-6 col-xs-12">
                                         ...
                                         <input class="form-control col-md-8 col-xs-12" value="<?php //echo $row->nama; ?>" id="nama" placeholder="Nama customer" required type="text" name="nama" required>
                                       </div>
                                     </div>

        				              <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Alamat customer
                                </label>
                                <div class="col-md-8 col-sm-6 col-xs-12">
     ...
     <!-- form start -->
                 ...
                 <div class="box-body">
                   <div class="form-group">
                     <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">ID Customer
                     </label>
                     <div class="col-md-4 col-sm-6 col-xs-12">

                     <input class="form-control col-md-4 col-xs-12"  name="id_customer" type="text" value="<?php  echo $row->id_customer; ?>" placeholder="AUTO" readonly />
                     </div>
                   </div>
