...
<?php $action_form = 'Putrans/tambah'; ?>
         ...
         <div class="col-md-8">
           ...
           <label>Supplier </label>
              <div class="input-group">
                ...
                <input id="nama_supplier" class="form-control col-md-3 col-xs-12" type="text" name="nama_supplier" readonly>
              </div>
           <label>Alamat </label>
           <div class="input-group">
             <div class="input-group-addon">
             ...
             <input id="alamat_supplier" class="form-control col-md-6 col-xs-12" type="text" name="alamat_supplier" readonly>
           </div>
         </div>
