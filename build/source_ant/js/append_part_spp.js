	  ...
	  alert(tot_harga);
		...
		jq_append('#containeritem').append(
			'<tr class="records">'
				...
				+ '</td>'
				+ '<td>'
					+ '<input style="width:100%" id="no_spp_' + count + '" name="no_spp_' + count + '" type="text" value="'+ no_spp[0].value +'" readonly />'
				+ '</td>'
				...
				+ '<td>'
				+ '<span class="nilaiHb" hidden>'+ hb_barang[0].value +'</span>'
				+ '<input style="width:100%; background:#BBECBE;" id="hb_' + count + '" name="hb_' + count + '" type="number" value="'+ hb_barang[0].value +'" />'
				+ '</td>'

				+ '<td>'
				+ '<span class="nilaiTotal" hidden>'+ tot_harga +'</span>'
				+ '<input style="width:100%; " id="total_' + count + '" name="total_' + count + '" type="number" value="'+ tot_harga +'" readonly />'
				+ '</td>'
