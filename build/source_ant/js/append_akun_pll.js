...
jq_append(document).ready(function() {
	...
	var nilai_k_bank = jq_append('#TOTAL');
	var kd_akun_fil = jq_append('#kd_akun_fil');
	var kd_bank_fil = jq_append('#kd_bank_fil');
	...
	jq_append("#add_jurnal").click(function(){
		var kd_bank1_xx = document.getElementById('kd_bank_fil').value;
		if (kd_bank1_xx == ''){
			alert ("Pilih Bank/Kas terlebih dulu" );
			...
			jq_append('#containerBM').append(
				'<tr class="records">'
					...
					+ '</td>'
					+ '<td>'
						+ '<input style="width:100%" id="nama_akun_' + count + '" name="nama_akun_' + count + '" type="text" value="'+ nama_bank[0].value +'" readonly />'
					+ '</td>'
					+ '<td>'
						+ '<input style="width:100%" id="x_kode_akun_' + count + '" name="x_kode_akun_' + count + '" type="text" value="'+ kd_akun_fil[0].value +'" readonly />'
					+ '</td>'
					+ '<td>'
						+ '<input style="width:100%" id="keterangan_' + count + '" name="keterangan_' + count + '" type="text" value="'+ keterangan_akun[0].value +'"   />'
					+ '</td>'
					+ '<td>'
						+ '<span class="nilaiD" hidden>'+ nilai_k_bank[0].value +'</span>'
						+ '<input style="width:100%; text-align:right" id="nilai_debet_' + count + '" name="nilai_debet_' + count + '" type="text" value="'+ nilai_k_bank[0].value +'" readonly />'
					+ '</td>'
					+ '<td>'
						+ '<span class="nilaiK" hidden></span>'
						+ '<input style="width:100%; text-align:right" id="nilai_kredit_' + count + '" name="nilai_kredit_' + count + '" type="text" value="" readonly />'
					+ '</td>'
					+ '<td align="center">'
						+ '<input id="rows_' + count + '" name="rowsBM[]" value="'+ count +'" type="hidden" />'
						+ ' <a class="remove_item" href="#" >'
