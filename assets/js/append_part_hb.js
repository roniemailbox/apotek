...
if (x =='' || y=='' || y==0) {
	...
	jq_append('#containeritem').append(
		'<tr class="records">'
			...
			+ '</td>'
			+ '<td>'
				+ '<input class="form-control" style="width:100%; text-align:right" id="hb_' + count + '" name="hb_' + count + '" type="number" value="'+ hb_barang[0].value +'" onchange="recounter();" onblur="recounter();" readonly />'
			+ '</td>'
